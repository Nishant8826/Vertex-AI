...
export const codingAgent = async (state) => {
  ...
  const response = await llm.invoke(`You are vertexAI Coding Agent.
      ...
      Do NOT generate about.html, contact.html, pricing.html unless explicitly requested.
      ...
      JAVASCRIPT
      =========================
      Keep JS minimal. Only interactive logic. No unnecessary functions.

      =========================
      OUTPUT
      =========================
      If intent is CODE_GENERATION, return ONLY:
      FILE: index.html
      ...
      FILE: style.css
      ...
      ...
      If intent is REVIEW / EXPLAIN / DEBUG, return Markdown only. Do NOT generate project files.

      =========================
      TOKEN BUDGET
      =========================
      Maximum ~2000 output tokens. Prefer concise but beautiful code. Generate only what is required.
