          ...
          >
              ...
              <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <h3 className="text-white text-xl font-bold">{userData?.plan ?? "Pro"}</h3>
                  </div>
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4">
              ...
              <div className="rounded-xl border border-indigo-500 p-4 relative">
                <span className="absolute right-3 top-3 text-xs bg-indigo-600 px-2 py-1 rounded-full text-white">Popular</span>
            ...
            <div className="p-5 border-t border-white/10">
              <p className="text-xs text-slate-500">Credits are used for Image, PDF, PPT and AI Generation.</p>
            </div>
          </motion.div>
        </>
      )}
